...
`get_images` supports three source names for use with `filter_source_names`:
...
**Note:** The infrared stream is automatically enabled if the camera supports it. No additional configuration is required.
